...
import backIcon from '../debug-modal/icons/icon--prev.svg';

import scratchLogo from './scratch-logo.svg';
import zerLogo from './zer-logo.png';
...
const ariaMessages = defineMessages({
    ...
    goBack: {
        ...
        description: 'accessibility text for the go back button'
    }
});
                ...
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        <div className={classNames(styles.menuBarItem)}>
                            <img
                                alt="Zer"
                                className={classNames(styles.zerLogo)}
                                draggable={false}
                                src={zerLogo}
                            />
                    ...
                    <div className={styles.fileGroup}>
                        <div
                            aria-label={this.props.intl.formatMessage(ariaMessages.goBack)}
                            className={classNames(styles.menuBarItem, styles.noOffset, styles.hoverable, styles.goBackButton)}
                            onClick={this.handleGoBack}
                        >
                            <span className={styles.goBackLabel}>
                                <FormattedMessage {...ariaMessages.goBack} />
                            </span>
                        </div>
                    </div>
                </div>
